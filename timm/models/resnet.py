...
default_cfgs = {
    ...
    "seresnet50tn": _cfg(url="", interpolation="bicubic", first_conv="conv1.0"),
    ...
    "seresnext26_32x4d": _cfg(url="", interpolation="bicubic"),
    ...
    "ecaresnext26tn_32x4d": _cfg(url="", interpolation="bicubic", first_conv="conv1.0"),
    "ecaresnext50_32x4d": _cfg(url="", interpolation="bicubic"),
