...
def _create_model(model_kwargs, variant, pretrained=False):
    ...
    model_weight_path = model_kwargs.pop("model_weight_path_folder", None)
    ...
    if pretrained:
        ...
        if model_weight_path is None:
            ...
            model_filename = os.path.join(
                model_weight_path, filename_from_url(model_urls[variant]))

            if not os.path.exists(model_filename):
                download_url_to_file(model_urls[variant],
                                     model_filename,
                                     progress=True)
...
def mnasnet_050(pretrained=False, **kwargs):
    ...
    model = _gen_mnasnet_b1("mnasnet_050",
                            0.5,
...
def mnasnet_075(pretrained=False, **kwargs):
    ...
    model = _gen_mnasnet_b1("mnasnet_075",
                            0.75,
                            pretrained=pretrained,
                            **kwargs)
    return model
...
def mnasnet_100(pretrained=False, **kwargs):
    ...
    model = _gen_mnasnet_b1("mnasnet_100",
                            1.0,
                            pretrained=pretrained,
                            **kwargs)
    return model
...
def mnasnet_140(pretrained=False, **kwargs):
    ...
    model = _gen_mnasnet_b1("mnasnet_140",
                            1.4,
                            pretrained=pretrained,
                            **kwargs)
    return model
...
def semnasnet_050(pretrained=False, **kwargs):
    ...
    model = _gen_mnasnet_a1("semnasnet_050",
                            0.5,
                            pretrained=pretrained,
                            **kwargs)
    return model
...
def semnasnet_075(pretrained=False, **kwargs):
    ...
    model = _gen_mnasnet_a1("semnasnet_075",
                            0.75,
                            pretrained=pretrained,
                            **kwargs)
    return model
...
def semnasnet_100(pretrained=False, **kwargs):
    ...
    model = _gen_mnasnet_a1("semnasnet_100",
                            1.0,
                            pretrained=pretrained,
                            **kwargs)
    return model
...
def semnasnet_140(pretrained=False, **kwargs):
    ...
    model = _gen_mnasnet_a1("semnasnet_140",
                            1.4,
                            pretrained=pretrained,
                            **kwargs)
    return model
...
def mnasnet_small(pretrained=False, **kwargs):
    ...
    model = _gen_mnasnet_small("mnasnet_small",
                               1.0,
                               pretrained=pretrained,
                               **kwargs)
    return model
...
def mobilenetv2_100(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v2("mobilenetv2_100",
                              1.0,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def mobilenetv2_140(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v2("mobilenetv2_140",
                              1.4,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def mobilenetv2_110d(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v2("mobilenetv2_110d",
                              1.1,
...
def mobilenetv2_120d(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v2("mobilenetv2_120d",
                              1.2,
...
def efficientnet_b0(pretrained=False, **kwargs):
    ...
    model = _gen_efficientnet("efficientnet_b0",
                              channel_multiplier=1.0,
                              depth_multiplier=1.0,
                              pretrained=pretrained,
                              **kwargs)
...
def efficientnet_b1(pretrained=False, **kwargs):
    """ EfficientNet-B1 """
    # NOTE for train set drop_rate=0.2, drop_connect_rate=0.2
    model = _gen_efficientnet("efficientnet_b1",
                              channel_multiplier=1.0,
...
def efficientnet_b2(pretrained=False, **kwargs):
    ...
    model = _gen_efficientnet("efficientnet_b2",
...
def efficientnet_b3(pretrained=False, **kwargs):
    """ EfficientNet-B3 """
    # NOTE for train set drop_rate=0.3, drop_connect_rate=0.2
    model = _gen_efficientnet("efficientnet_b3",
...
def efficientnet_b4(pretrained=False, **kwargs):
    ...
    model = _gen_efficientnet("efficientnet_b4",
...
def efficientnet_b5(pretrained=False, **kwargs):
    """ EfficientNet-B5 """
    # NOTE for train set drop_rate=0.4, drop_connect_rate=0.2
    model = _gen_efficientnet("efficientnet_b5",
...
def efficientnet_b6(pretrained=False, **kwargs):
    ...
    model = _gen_efficientnet("efficientnet_b6",
...
def efficientnet_b7(pretrained=False, **kwargs):
    """ EfficientNet-B7 """
    # NOTE for train set drop_rate=0.5, drop_connect_rate=0.2
    model = _gen_efficientnet("efficientnet_b7",
...
def efficientnet_b8(pretrained=False, **kwargs):
    """ EfficientNet-B8 """
    # NOTE for train set drop_rate=0.5, drop_connect_rate=0.2
    model = _gen_efficientnet("efficientnet_b8",
...
def efficientnet_l2(pretrained=False, **kwargs):
    ...
    model = _gen_efficientnet("efficientnet_l2",
...
def efficientnet_em(pretrained=False, **kwargs):
    ...
    model = _gen_efficientnet_edge("efficientnet_em",
                                   channel_multiplier=1.0,
                                   depth_multiplier=1.1,
                                   pretrained=pretrained,
                                   **kwargs)
...
def efficientnet_el(pretrained=False, **kwargs):
    ...
    model = _gen_efficientnet_edge("efficientnet_el",
                                   channel_multiplier=1.2,
                                   depth_multiplier=1.4,
                                   pretrained=pretrained,
                                   **kwargs)
...
def efficientnet_cc_b0_4e(pretrained=False, **kwargs):
    ...
    model = _gen_efficientnet_condconv("efficientnet_cc_b0_4e",
                                       channel_multiplier=1.0,
                                       depth_multiplier=1.0,
                                       pretrained=pretrained,
                                       **kwargs)
...
def efficientnet_lite0(pretrained=False, **kwargs):
    """ EfficientNet-Lite0 """
    model = _gen_efficientnet_lite("efficientnet_lite0",
                                   channel_multiplier=1.0,
                                   depth_multiplier=1.0,
                                   pretrained=pretrained,
                                   **kwargs)
...
def efficientnet_lite1(pretrained=False, **kwargs):
    """ EfficientNet-Lite1 """
    model = _gen_efficientnet_lite("efficientnet_lite1",
                                   channel_multiplier=1.0,
                                   depth_multiplier=1.1,
                                   pretrained=pretrained,
                                   **kwargs)
...
def efficientnet_lite2(pretrained=False, **kwargs):
    """ EfficientNet-Lite2 """
    model = _gen_efficientnet_lite("efficientnet_lite2",
                                   channel_multiplier=1.1,
                                   depth_multiplier=1.2,
                                   pretrained=pretrained,
                                   **kwargs)
...
def efficientnet_lite3(pretrained=False, **kwargs):
    """ EfficientNet-Lite3 """
    model = _gen_efficientnet_lite("efficientnet_lite3",
                                   channel_multiplier=1.2,
                                   depth_multiplier=1.4,
                                   pretrained=pretrained,
                                   **kwargs)
...
def efficientnet_lite4(pretrained=False, **kwargs):
    """ EfficientNet-Lite4 """
    model = _gen_efficientnet_lite("efficientnet_lite4",
                                   channel_multiplier=1.4,
                                   depth_multiplier=1.8,
                                   pretrained=pretrained,
                                   **kwargs)
...
def tf_efficientnet_b0(pretrained=False, **kwargs):
    ...
    model = _gen_efficientnet("tf_efficientnet_b0",
                              channel_multiplier=1.0,
                              depth_multiplier=1.0,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b1(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b1",
                              channel_multiplier=1.0,
                              depth_multiplier=1.1,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b2(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b2",
                              channel_multiplier=1.1,
                              depth_multiplier=1.2,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b3(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b3",
                              channel_multiplier=1.2,
                              depth_multiplier=1.4,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b4(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b4",
                              channel_multiplier=1.4,
                              depth_multiplier=1.8,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b5(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b5",
                              channel_multiplier=1.6,
                              depth_multiplier=2.2,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b6(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b6",
                              channel_multiplier=1.8,
                              depth_multiplier=2.6,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b7(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b7",
                              channel_multiplier=2.0,
                              depth_multiplier=3.1,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b8(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b8",
                              channel_multiplier=2.2,
                              depth_multiplier=3.6,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b0_ap(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b0_ap",
                              channel_multiplier=1.0,
                              depth_multiplier=1.0,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b2_ap(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b2_ap",
                              channel_multiplier=1.1,
                              depth_multiplier=1.2,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b3_ap(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b3_ap",
                              channel_multiplier=1.2,
                              depth_multiplier=1.4,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b4_ap(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b4_ap",
                              channel_multiplier=1.4,
                              depth_multiplier=1.8,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b5_ap(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b5_ap",
                              channel_multiplier=1.6,
                              depth_multiplier=2.2,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b6_ap(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b6_ap",
                              channel_multiplier=1.8,
                              depth_multiplier=2.6,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b7_ap(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b7_ap",
                              channel_multiplier=2.0,
                              depth_multiplier=3.1,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b8_ap(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b8_ap",
                              channel_multiplier=2.2,
                              depth_multiplier=3.6,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b0_ns(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b0_ns",
                              channel_multiplier=1.0,
                              depth_multiplier=1.0,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b1_ns(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b1_ns",
                              channel_multiplier=1.0,
                              depth_multiplier=1.1,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b2_ns(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b2_ns",
                              channel_multiplier=1.1,
                              depth_multiplier=1.2,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b4_ns(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b4_ns",
                              channel_multiplier=1.4,
                              depth_multiplier=1.8,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b5_ns(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b5_ns",
                              channel_multiplier=1.6,
                              depth_multiplier=2.2,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b6_ns(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b6_ns",
                              channel_multiplier=1.8,
                              depth_multiplier=2.6,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_b7_ns(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_b7_ns",
                              channel_multiplier=2.0,
                              depth_multiplier=3.1,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_l2_ns_475(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_l2_ns_475",
                              channel_multiplier=4.3,
                              depth_multiplier=5.3,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_l2_ns(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet("tf_efficientnet_l2_ns",
                              channel_multiplier=4.3,
                              depth_multiplier=5.3,
                              pretrained=pretrained,
                              **kwargs)
...
def tf_efficientnet_es(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet_edge("tf_efficientnet_es",
                                   channel_multiplier=1.0,
                                   depth_multiplier=1.0,
                                   pretrained=pretrained,
                                   **kwargs)
...
def tf_efficientnet_em(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet_edge("tf_efficientnet_em",
                                   channel_multiplier=1.0,
                                   depth_multiplier=1.1,
                                   pretrained=pretrained,
                                   **kwargs)
...
def tf_efficientnet_el(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet_edge("tf_efficientnet_el",
                                   channel_multiplier=1.2,
                                   depth_multiplier=1.4,
                                   pretrained=pretrained,
                                   **kwargs)
...
def tf_efficientnet_cc_b0_4e(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet_condconv("tf_efficientnet_cc_b0_4e",
                                       channel_multiplier=1.0,
                                       depth_multiplier=1.0,
                                       pretrained=pretrained,
                                       **kwargs)
...
def tf_efficientnet_lite0(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet_lite("tf_efficientnet_lite0",
                                   channel_multiplier=1.0,
                                   depth_multiplier=1.0,
                                   pretrained=pretrained,
                                   **kwargs)
...
def tf_efficientnet_lite1(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet_lite("tf_efficientnet_lite1",
                                   channel_multiplier=1.0,
                                   depth_multiplier=1.1,
                                   pretrained=pretrained,
                                   **kwargs)
...
def tf_efficientnet_lite2(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet_lite("tf_efficientnet_lite2",
                                   channel_multiplier=1.1,
                                   depth_multiplier=1.2,
                                   pretrained=pretrained,
                                   **kwargs)
...
def tf_efficientnet_lite3(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet_lite("tf_efficientnet_lite3",
                                   channel_multiplier=1.2,
                                   depth_multiplier=1.4,
                                   pretrained=pretrained,
                                   **kwargs)
...
def tf_efficientnet_lite4(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_efficientnet_lite("tf_efficientnet_lite4",
                                   channel_multiplier=1.4,
                                   depth_multiplier=1.8,
                                   pretrained=pretrained,
                                   **kwargs)
...
def mixnet_l(pretrained=False, **kwargs):
    ...
    # NOTE for train set drop_rate=0.25
    model = _gen_mixnet_m("mixnet_l",
                          channel_multiplier=1.3,
                          pretrained=pretrained,
                          **kwargs)
    return model
...
def mixnet_xxl(pretrained=False, **kwargs):
    ...
    """
    # NOTE for train set drop_rate=0.3, drop_connect_rate=0.2
    model = _gen_mixnet_m("mixnet_xxl",
...
def tf_mixnet_s(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_mixnet_s("tf_mixnet_s",
                          channel_multiplier=1.0,
                          pretrained=pretrained,
                          **kwargs)
    return model
...
def tf_mixnet_m(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_mixnet_m("tf_mixnet_m",
                          channel_multiplier=1.0,
                          pretrained=pretrained,
                          **kwargs)
    return model
...
def tf_mixnet_l(pretrained=False, **kwargs):
    ...
    kwargs["bn_eps"] = BN_EPS_TF_DEFAULT
    kwargs["pad_type"] = "same"
    model = _gen_mixnet_m("tf_mixnet_l",
                          channel_multiplier=1.3,
                          pretrained=pretrained,
                          **kwargs)
    return model
