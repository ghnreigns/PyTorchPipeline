...
def _create_model(model_kwargs, variant, pretrained=False):
    ...
    model_weight_path = model_kwargs.pop("model_weight_path", None)
...
def _gen_mobilenet_v3_rw(variant,
    ...
    with layer_config_kwargs(kwargs):
        model_kwargs = dict(
            ...
            se_kwargs=dict(gate_fn=get_act_fn('hard_sigmoid'),
                           reduce_mid=True),
...
def _gen_mobilenet_v3(variant,
    ...
    with layer_config_kwargs(kwargs):
        model_kwargs = dict(
            ...
            se_kwargs=dict(act_layer=get_act_layer('relu'),
...
def mobilenetv3_large_075(pretrained=False, **kwargs):
    ...
    # NOTE for train set drop_rate=0.2
    model = _gen_mobilenet_v3('mobilenetv3_large_075',
                              0.75,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def mobilenetv3_large_100(pretrained=False, **kwargs):
    ...
    # NOTE for train set drop_rate=0.2
    model = _gen_mobilenet_v3('mobilenetv3_large_100',
                              1.0,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def mobilenetv3_large_minimal_100(pretrained=False, **kwargs):
    ...
    # NOTE for train set drop_rate=0.2
    model = _gen_mobilenet_v3('mobilenetv3_large_minimal_100',
                              1.0,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def mobilenetv3_small_075(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v3('mobilenetv3_small_075',
                              0.75,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def mobilenetv3_small_100(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v3('mobilenetv3_small_100',
                              1.0,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def mobilenetv3_small_minimal_100(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v3('mobilenetv3_small_minimal_100',
                              1.0,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def tf_mobilenetv3_large_075(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v3('tf_mobilenetv3_large_075',
                              0.75,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def tf_mobilenetv3_large_100(pretrained=False, **kwargs):
    ...
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_mobilenet_v3('tf_mobilenetv3_large_100',
                              1.0,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def tf_mobilenetv3_large_minimal_100(pretrained=False, **kwargs):
    ...
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_mobilenet_v3('tf_mobilenetv3_large_minimal_100',
                              1.0,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def tf_mobilenetv3_small_075(pretrained=False, **kwargs):
    ...
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_mobilenet_v3('tf_mobilenetv3_small_075',
                              0.75,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def tf_mobilenetv3_small_100(pretrained=False, **kwargs):
    ...
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_mobilenet_v3('tf_mobilenetv3_small_100',
                              1.0,
                              pretrained=pretrained,
                              **kwargs)
    return model
...
def tf_mobilenetv3_small_minimal_100(pretrained=False, **kwargs):
    ...
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_mobilenet_v3('tf_mobilenetv3_small_minimal_100',
                              1.0,
                              pretrained=pretrained,
                              **kwargs)
    return model
